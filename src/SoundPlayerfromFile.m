...
- (void)playSoundFromFile {
    NSString *sharedFolder = [NSString stringWithUTF8String:getenv("LC_SHARED_FOLDER")];
    NSString *audioPath = [sharedFolder stringByAppendingPathComponent:@"60Parsecs-2.mp3"];
